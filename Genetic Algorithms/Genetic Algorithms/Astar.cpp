...
string astar(Map &_map)
{
	...
	{
		map[_map.m_walls[i]->m_xPos][_map.m_walls[i]->m_yPos] = 1;
	}
    
   
    int xA, yA, xB, yB;
	xA = _map.m_start.m_xPos;
	yA = _map.m_start.m_yPos;
	xB = _map.m_end.m_xPos;
	yB = _map.m_end.m_yPos;
